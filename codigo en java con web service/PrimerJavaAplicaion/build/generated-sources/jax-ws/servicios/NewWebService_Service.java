 ...
 * 
 */
@WebServiceClient(name = "NewWebService", targetNamespace = "http://servicios/", wsdlLocation = "http://localhost:8080/WebApplication_2/NewWebService?WSDL")
    ...
    extends Service
{
    ...
    private final static QName NEWWEBSERVICE_QNAME = new QName("http://servicios/", "NewWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/WebApplication_2/NewWebService?WSDL");
    ...
    public NewWebService getNewWebServicePort() {
        return super.getPort(new QName("http://servicios/", "NewWebServicePort"), NewWebService.class);
    }
    ...
    public NewWebService getNewWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://servicios/", "NewWebServicePort"), NewWebService.class, features);
    }
